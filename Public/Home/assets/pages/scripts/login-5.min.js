var Login = function() {
    var r = function() {
        ...
        }), $("#forget-password").click(function() { $(".login-form").hide(), $(".forget-form").show() }), $("#back-btn").click(function() { $(".login-form").show(), $(".forget-form").hide() })
    };
    return { init: function() { r(), $(".login-bg").backstretch(["http://www.ysmwzgy.com/Public/Home/images/64901.jpg", "http://www.ysmwzgy.com/Public/Home/images/02.jpg", "http://www.ysmwzgy.com/Public/Home/images/03.jpg"], { fade: 1e3, duration: 8e3 }), $(".forget-form").hide() } }
}();
