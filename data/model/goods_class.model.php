...
class goods_classModel extends Model
{
    ...
    private function _condition($condition)
    {
        ...
        if ($condition['no_id'] != '') {
            $condition_str .= " and id != '" . intval($condition['no_ac_id']) . "'";
        }
        if ($condition['typename'] != '') {
            $condition_str .= " and typename = '" . $condition['typename'] . "'";
        }
     ...
     * @return array 数组类型的返回结果
     */
    public function getOneClassField($id, $field)
    {
        if (intval($id) > 0) {
            $param = array();
            $param['table'] = 'goods_type';
    ...
    public function add($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = Db::insert('goods_type', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function updates($param)
    {
        ...
        if (is_array($param)) {
            ...
            $where = " id = '" . $param['id'] . "'";
            $result = Db::update('goods_type', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function del($id)
    {
        if (intval($id) > 0) {
            $where = " id = '" . intval($id) . "'";
            $result = Db::delete('goods_type', $where);
            return $result;
        } else {
            return false;
        }
