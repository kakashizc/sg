...
$(function(){
    $("#flexigrid").flexigrid({
    	...
    	colModel : [
			...
			{display: '标题', name : 'title', width : 240, sortable : true, align: 'left'},
    		{display: '文章分类', name : 'typename', width : 150, sortable : true, align: 'left'},
			{display: '显示', name : 'article_show', width: 80, sortable : true, align : 'center'},
			{display: '添加时间', name : 'addtime', width: 160, sortable : true, align : 'center'}
    		],
        buttons : [
