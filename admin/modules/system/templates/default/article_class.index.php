...
<script type="text/javascript">
    $(function () {
        $("#flexigrid").flexigrid({
            url: 'index.php?act=article_class&op=get_goods_class_xml',
            colModel: [
                {display: '操作', name: 'operation', width: 150, sortable: false, align: 'center', className: 'handle'},
                {display: '分类ID', name: 'gid', width: 150, sortable: false, align: 'left'},
                {display: '分类名称', name: 'typename', width: 240, sortable: false, align: 'left'},
            ],
            buttons: [
                {
    ...
    function fg_delete(id) {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "index.php?act=article_class&op=article_class_delete",
            data: "del_id=" + id,
