...
<script type="text/javascript">
    $(function () {
        $("#flexigrid").flexigrid({
            url: 'index.php?act=goods&op=get_goods_class_xml',
            colModel: [
    ...
    function fg_operate(name, bDiv) {
        if (name == 'del') {
            ...
            window.location.href = 'index.php?act=goods&op=goods_class_add';
        }
    }
    ...
    function fg_delete(id) {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "index.php?act=goods&op=goods_class_delete",
            data: "del_id=" + id,
