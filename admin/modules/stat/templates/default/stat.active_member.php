...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>统计图展示了时间段内激活会员数的走势和与前一时间段的对比</li>
      <li>统计表展示了时间段内激活会员数值和与前一时间段的同比数值，点击每条记录后的“查看”，了解激活会员的详细信息</li>
  ...
  <table class="flex-table">
    ...
    <tbody id="datatable">
      ...
      <tr>
        ...
        <td class="handle-s"><a href="index.php?act=stat_member_active&op=showmember&type=newbyday&t=<?php echo $v['seartime'];?>" class="btn green"><i class="fa fa-list-alt"></i>查看</a></td>
      ...
      <tr>
        <td class="sign"><i class="ico-check"></i></td>
        <td class="handle-s"><a href="index.php?act=stat_member_active&op=showmember&type=newbyday&t=<?php echo $output['count_arr']['seartime'];?>" class="btn green"><i class="fa fa-list-alt"></i>查看</a></td>
        <td><b>总计</b></td>
  ...
  <div class="ncap-search-bar">
    ...
    <input type="hidden" name="act" value="stat_member_active" />
