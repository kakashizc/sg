...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?act=inbox" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3>回复“<?php echo $output['message_array']['title'];?>”</h3>
        <h5><?php echo $lang['message_index_manage_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="message_form" method="post">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="id" value="<?php echo $output['message_array']['id'];?>" />
	<input type="hidden" name="toid" value="<?php echo $output['message_array']['formid'];?>" />
    <input type="hidden" name="ref_url" value="<?php echo getReferer();?>" />
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="message_title"><em>*</em>标题</label>
        </dt>
        <dd class="opt">
          <input type="text" value="回复：<?php echo $output['message_array']['title'];?>" name="title" id="title" class="input-txt">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <?php showEditor('content',$output['message_array']['content'] . "<br>- - - - - -  - - -  - -  - -  - -  - -  - - -  - - -  - -  - - - - - -  - -  - - - - - - - - - -  - - - - - - - - - - - - - - - - - - - -  -- - - - - - -  <br>回复内容：");?>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
