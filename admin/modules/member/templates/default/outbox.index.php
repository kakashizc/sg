...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=outbox&op=get_xml',
        colModel : [
            {display: '操作', name : 'operation', width : 60, sortable : false, align: 'center', className: 'handle-s'},
            {display: '标题', name : 'title', width : 300, sortable : true, align: 'left'},
			{display: '收件人', name : 'toname', width : 120, sortable : true, align: 'left'},
			{display: '日期', name : 'date', width : 150, sortable : true, align: 'left'},
			{display: '阅读', name : 'is_read', width : 40, sortable : true, align: 'left'},
            ],
        buttons : [
            ],
        searchitems : [
